...
const PrivacyPolicy = () => {
  ...
  return (
    <>
      <HeadBlock title="プライバシーポリシー | VALORANT FINDER" />
      {isPcSite && (
        <Box sx={{ width: 900 }}>
          <Grid container direction="column" justifyContent="center" alignItems="center">
            <Typography variant="h4" sx={{ mb: 7, mt: 10 }}>
              プライバシーポリシー
            </Typography>
          </Grid>
          <Grid container direction="column" justifyContent="center" alignItems="start">
            <Typography sx={{ mb: 5 }}>
              VALORANT FINDERの運営者（以下、「当方」といいます）は、ユーザーの個人情報について以下のとおりプライバシーポリシー（以下、「本ポリシー」といいます）を定めます。
            ...
            <Grid container direction="row">
              <Typography sx={{ mb: 3 }}>お客様の情報の開示、情報の訂正、利用停止、削除をご希望の場合は、</Typography>
              <Typography component={Link} to="/contact">
                お問合せフォーム
              </Typography>
              <Typography>にご連絡ください。</Typography>
            </Grid>
          </Grid>
      ...
      {isMobileSite && (
        <Box sx={{ width: "90vw" }}>
          <Grid container direction="column" justifyContent="center" alignItems="center">
            <Typography variant="h4" sx={{ mb: 7, mt: 10, fontSize: "24px" }}>
              プライバシーポリシー
            </Typography>
          </Grid>
          <Grid container direction="column" justifyContent="center" alignItems="start">
            ...
            <Typography component="a" href="https://marketingplatform.google.com/about/analytics/terms/jp" target="_blank" rel="noopener noreferrer" css={url}>
              https://marketingplatform.google.com/about/analytics/terms/jp/
            </Typography>
            <Typography variant="h5" sx={{ mb: 3, mt: 5 }}>
              6. プライバシーポリシーの変更
